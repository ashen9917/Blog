...
<section class="bg-dark text-light p-5 text-center text-sm-start">
    <div class="container">
        <div class="d-sm-flex align-items-center justify-content-between">
            <div>
                <h1>Welcome to <span class="text-warning">My Official Block</span></h1>
                <p class="lead my-4">
                    This is my official block. In this blog I tried to present some of my personal details and also about my higher study.
                    </br>
                    <span class="text-info">So, always be with me</span>
                </p>
                <button class="btn btn-primary btn-lg" data-bs-toggle='modal' data-bs-target=#enroll>Connect With Me</button>
            </div>
...
<footer class="p-5 bg-dark text-white text-center position-relative">
    <div class="container">
        <p class="lead">Banuka Ashen Indula Kulasinghe &copy; ashenindula@gmail.com</p>
