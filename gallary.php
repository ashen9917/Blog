    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-md p-5">
                <img class="w-100" src="img/r.jpg" alt="" class="imd-fluid">
            </div>
            <div class="col-md">
                <img class="w-100" src="img/rr.jpg" alt="" class="imd-fluid">
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md">
                <img class="w-100" src="img/ss.jpg" alt="" class="imd-fluid">
            </div>
            <div class="col-md">
                <img class="w-100" src="img/sss.jpg" alt="" class="imd-fluid">
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-md p-5">
                <img class="w-100" src="img/x.jpg" alt="" class="imd-fluid">
            </div>
            <div class="col-md">
                <img class="w-100" src="img/xx.jpg" alt="" class="imd-fluid">
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md">
                <img class="w-100" src="img/s.jpg" alt="" class="imd-fluid">
            </div>

            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-md p-5">
                        <img class="w-100" src="img/z.jpg" alt="" class="imd-fluid">
                    </div>
                    <div class="col-md">
                        <img class="w-100" src="img/zz.jpg" alt="" class="imd-fluid">
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="col-md">
                    <img class="w-100" src="img/zzz.jpg" alt="" class="imd-fluid">
                </div>
            </div>
        </div>
    </div>
